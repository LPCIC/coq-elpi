(* Generates inversion lemmas by encoding indexes with equations and non
   ...
   ------------------------------------------------------------------------- *)
From elpi.apps.derive.elpi Extra Dependency "invert.elpi" as invert.
...
(* hook into derive *)
#[superglobal] Elpi Accumulate derive Db derive.invert.db.
#[superglobal] Elpi Accumulate derive File invert.
