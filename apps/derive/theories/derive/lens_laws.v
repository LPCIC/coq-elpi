...
Definition law2_on {a c} (l : Lens a a c c) r := forall x y,
  set l y (set l x r) = set l y r.
Definition law2 {a c} (l : Lens a a c c) := forall r, law2_on l r.

Definition law3_on {a c} (l : Lens a a c c) r :=
  set l (view l r) r = r.
Definition law3 {a c} (l : Lens a a c c) := forall r, law3_on l r.
  
Definition law4_on {a b d} (l1 : Lens a a b b) (l2 : Lens a a d d) r := forall x y,
  set l1 x (set l2 y r) = set l2 y (set l1 x r).
Definition law4 {a b d} (l1 : Lens a a b b) (l2 : Lens a a d d) := forall r, law4_on l1 l2 r.
