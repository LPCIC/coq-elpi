...
Elpi Accumulate tc.db lp:{{
  pred explored_gref -> gref.

  pred should_fail list gref, gref, gref. 
  should_fail [] _ _. 
  ...
  pred already_explored gref, gref. 
  ...
  pred get_other gref -> gref.

  pred under_extra gref, list (pred) -> list (pred).
