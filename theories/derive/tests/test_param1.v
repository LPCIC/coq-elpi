...
Elpi Query derive.param1 "reali-with-TC (reali {{O}} Y)".
Elpi Query derive.param1 "reali-with-TC (reali {{S (S 0)}} Y)".
Elpi Query derive.param1 "with-TC {{@reali_db}} reali-retrieve (reali {{nat}} Y)".
