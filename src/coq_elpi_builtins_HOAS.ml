...
macro @udecl-const! Binders SB Constraints SC :-
  get-option "coq:udecl:const" (univ-decl-for-const Binders SB Constraints SC).
macro @udecl-indt! BindersVariance SB Constraints SC Cumul :-
  get-option "coq:udecl:indt" (univ-decl-for-indt BindersVariance SB Constraints SC Cumul).

macro @univpoly! :-
  [@udecl-const! [] loose [] loose, @udecl-indt! [] loose [] loose tt].
