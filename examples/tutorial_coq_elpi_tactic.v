...
.. mquote:: .s(elpi show_more).msg{EVARS:*[?]X97*x + 1 = 0*}
   :language: text

.. mquote:: .s(elpi show_more).msg{Rocq-Elpi mapping:*RAW:*[?]X97 <-> *X1*ELAB:*[?]X97 <-> *X0*}
   :language: text

Here `?X97` is a Coq evar linked with Elpi's :e:`X0` and :e:`X1`.
